...
PlayerController::PlayerController(std::shared_ptr<Player> player,
                                   ...
                                   std::shared_ptr<Mouse> mouse) : _player(std::move(player)), _keyboard(std::move(keyboard)), _mouse(std::move(mouse)) {
}
...
void PlayerController::update() {
    ...
    camera->rotateLeft(disp.y() * MinecraftConsts::MOUSE_SENSITIVITY);
