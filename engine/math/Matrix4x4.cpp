...
Matrix4x4 Matrix4x4::Projection(double fov, double aspect, double ZNear, double ZFar) {
    ...
    p._arr[0][0] = 1 / (tan(Consts::PI * fov * 0.5 / 180) * aspect);
    p._arr[1][1] = 1 / tan(Consts::PI * fov * 0.5 / 180);
